...
![流程图](https://mangxieke.github.io/img/S2-001/images/流程图.png)
...
![action](https://mangxieke.github.io/img/S2-001/images/action.png)
...
![struts.xml](https://mangxieke.github.io/img/S2-001/images/struts_xml.png)
...
![LoginAction](https://mangxieke.github.io/img/S2-001/images/LoginAction.png)

![error](https://mangxieke.github.io/img/S2-001/images/error.png)
...
![结果](https://mangxieke.github.io/img/S2-001/images/结果.gif)

具体分析过程:

>1.在页面username输入admin,password输入%{1+1}

![输入值](https://mangxieke.github.io/img/S2-001/images/输入值.png)

> 2.在LoginAction处打个断点,拦截到了输入的值,可看到变量的值,这段代码比较简单,只有username和password的值都为admin时才返回成功,其余返回error

![获取到值](https://mangxieke.github.io/img/S2-001/images/获取到值.png)

> 3.根据LoginAction返回的error,struts_xml中会选择index.jsp进行渲染

![struts_2xml](https://mangxieke.github.io/img/S2-001/images/struts_2xml.png)

> 4.jsp文件中遇到Struts2标签 <s:textfield 时程序会先调用 doStartTag,并将标签中的属性设置到TextFieldTag对象相应属性中.在遇到 /> 结束标签的时候调用doEndTag方法

![index_jsp](https://mangxieke.github.io/img/S2-001/images/index_jsp.png)

> 5.在struts2-core-2.0.1.jar!/org/apache/struts2/views/jsp/ComponentTagSupport.class中找到doEndTag并设置断点

![doEndTag](https://mangxieke.github.io/img/S2-001/images/doEndTag.png)

> 6.按F7进入到end方法,继续F7进入evaluateParams方法

![end](https://mangxieke.github.io/img/S2-001/images/end.png)

> 7.在evaluateParams方法中可看到,如果开启altSyntax,将会在属性字段两边添加Ognl表达式字符( %{、} ),然后使用findValue方法从值栈中获得该表达式所对应的值

![altSyntax](https://mangxieke.github.io/img/S2-001/images/altSyntax.png)

> 8.添加前和添加后的对比,可看到password变成了%{password}

![对比](https://mangxieke.github.io/img/S2-001/images/对比.png)

> 9.F7进入findValue

![findValue](https://mangxieke.github.io/img/S2-001/images/findValue.png)

> 10.看到了罪魁祸首translateVariables,F7进入,可看到translateVariables又调用了同名重载方法,问题就出在这里

![translateVariables](https://mangxieke.github.io/img/S2-001/images/translateVariables.png)
...
![expression](https://mangxieke.github.io/img/S2-001/images/expression.png)
...
![o](https://mangxieke.github.io/img/S2-001/images/o.png)

F7进入findValue方法

![findValue2](https://mangxieke.github.io/img/S2-001/images/findValue2.png)

F7进入getValue方法,进入后根据name的值进行compile,name的值为password,会从root栈中LoginAction对象中获取到提交的参数%{1+1}并返回

![complie](https://mangxieke.github.io/img/S2-001/images/compile.png)

o经过一些处理后赋值给expression,expression变为%{1+1}

![expression_2](https://mangxieke.github.io/img/S2-001/images/express_2.png)

继续循环,进过findValue处理后可看到ongl表达式已被执行,结果为2

![succes](https://mangxieke.github.io/img/S2-001/images/sucess.png)
