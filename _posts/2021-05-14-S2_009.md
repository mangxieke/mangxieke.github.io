...
> 解压[地址](https://github.com/mangxieke/douzhe/tree/master/Struts2/S2-009)的S2-009.war文件,然后使用IDEA直接打开,然后配置好Tomcat就可以运行了
...
![流程图](https://mangxieke.github.io/img/S2-009/images/流程图.png)
