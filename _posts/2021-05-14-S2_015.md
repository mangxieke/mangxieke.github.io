...
![流程图](https://mangxieke.github.io/img/S2-015/images/流程图.png)
...
![1.png](https://mangxieke.github.io/img/S2-015/images/1.png)
...
![2.png](https://mangxieke.github.io/img/S2-015/images/2.png)

&emsp;&emsp;&emsp;&emsp;3.F8继续往下执行,F7进入executeResult方法

![3.png](https://mangxieke.github.io/img/S2-015/images/3.png)

&emsp;&emsp;&emsp;&emsp;4.根据传送的参数,继续执行到303行,F7进入execute方法

![4.png](https://mangxieke.github.io/img/S2-015/images/4.png)
...
![5.png](https://mangxieke.github.io/img/S2-015/images/5.png)

![6.png](https://mangxieke.github.io/img/S2-015/images/6.png)

&emsp;&emsp;&emsp;&emsp;6.对比下execute方法第86行和87行前后的结果,可见经过translateVariables方法后value的值从${message}变成了执行了id命令后的结果.

![7.png](https://mangxieke.github.io/img/S2-015/images/7.png)

![8.png](https://mangxieke.github.io/img/S2-015/images/8.png)
